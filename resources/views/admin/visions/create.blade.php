                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a href="#" class="nav-link" data-bs-toggle="tab"
                                data-bs-target="#headline-content-en" role="tab" aria-selected="false"
                        ...
                        <div class="tab-pane fade active show" id="headline-content-ar" role="tabpanel">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <x-dashboard.input-group type="text" name="title_ar" :title="trans('table.columns.name')" />
                                    </div>
                                    <div class="col-12 mt-3">
                                        <x-dashboard.label>{{ trans('table.columns.description') }}</x-dashboard.label>
                                        <textarea class="form-control" name="description_ar" cols="10" rows="6"></textarea>
