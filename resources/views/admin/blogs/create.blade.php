    ...
    <x-theme.tab-list :route="route('blogs.store')">
        <x-slot:arForm>
            ...
            <div class="col-md-6 col-12 mb-3">
                <x-dashboard.input-group type="text" name="title_ar" :title="trans('table.columns.title_ar')" />
            </div>
        ...
        <x-slot:enForm>
            ...
            <div class="col-12 mb-3">
                <x-dashboard.text-area name="content_ar" cols="30" rows="10" :title="trans('table.columns.content_ar')" />
            </div>
        </x-slot:enForm>
    </x-theme.tab-list>
