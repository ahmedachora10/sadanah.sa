...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin-assets/scenic/css/custom-bs.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-assets/scenic/css/jquery.fancybox.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-assets/scenic/css/icons.css') }}">

    <link rel="stylesheet" href="{{ asset('admin-assets/scenic/css/style.css') }}">
</head>
...
<body data-new-gr-c-s-check-loaded="14.1148.0" data-gr-ext-installed="">
    ...
    <script src="{{ asset('admin-assets/scenic/js/jquery.min.js') }}"></script>
    <script defer src="{{ asset('admin-assets/scenic/js/bootstrap.bundle.min.js') }}"></script>
    <script defer src="{{ asset('admin-assets/scenic/js/isotope.pkgd.min.js') }}"></script>
    <script defer src="{{ asset('admin-assets/scenic/js/stickyfill.min.js') }}"></script>
    <script defer src="{{ asset('admin-assets/scenic/js/jquery.fancybox.min.js') }}"></script>
    <script defer src="{{ asset('admin-assets/scenic/js/jquery.easing.1.3.js') }}"></script>
    <script defer src="{{ asset('admin-assets/scenic/js/jquery.waypoints.min.js') }}"></script>
    <script defer src="{{ asset('admin-assets/scenic/js/jquery.animateNumber.min.js') }}"></script>
    <script defer src="{{ asset('admin-assets/scenic/js/custom.js') }}"></script>
