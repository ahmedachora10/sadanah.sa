<div class="row align-content-end">
    <div class="col-md-4 col-12">
        <x-dashboard.input-group type="text" name="username" wire:model.defer="form.username" :title="trans('table.columns.name')" />
    </div>
    <div class="col-md-4 col-12">
        <x-dashboard.input-group type="text" name="phone" wire:model.defer="form.phone" :title="trans('table.columns.phone')" />
    </div>
    <div class="col-md-4 col-12">
    ...
    @foreach ($socialMediaPlatforms as $item)
        ...
        <div class="col-md-4 col-12">
            <x-dashboard.input-group type="text" name="{{ $item }}_username"
                wire:model.defer="form.{{ $item }}_username" :title="trans('table.columns.account')" />
        </div>
        <div class="col-md-4 col-12">
            <x-dashboard.input-group type="text" name="{{ $item }}_link"
