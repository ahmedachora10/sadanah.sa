<div class="row">
    ...
    <div class="col-xl-6 col-lg-6 mb-3">
        <x-dashboard.input-group type="text" wire:model.defer="form.email" name="form.email" :placeholder="trans('table.columns.email')" />
    </div>
    ...
    <div class="col-xl-6 col-lg-6 mb-3">
        <x-dashboard.input-group type="number" wire:model.defer="form.age" name="form.age" :placeholder="trans('table.columns.age')" />
    </div>
    ...
    <div class="col-12 mb-3">
        <x-dashboard.text-area wire:model.defer="form.excerpt" :placeholder="trans('table.columns.excerpt')" name="form.excerpt" cols="10" rows="6">
