...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const updateTranslations = (language) => {
    ...
    elements.forEach((element) => {
      ...
      if (translations[language] && translations[language][translateKey]) {
  ...
  const translations = {
    en: {
      ...
      sorryNotFound: "Sorry, but the page you are looking for does not exist.",
    ...
    ar: {
      ...
      skillItem7: "نعتني بالسرية ونلتزم بمبدأ خصوصية الأعمال القائمين عليها",
      jobs: "الوظائف",
      insta: "Instagram",
      "": "",
    },
